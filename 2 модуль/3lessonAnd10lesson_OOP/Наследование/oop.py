...
class House: #объект 
    def __init__(self,wall_color,roof_color,number,height = 100,width = 80):  #функция init класса house. в ней я указываю цвет крыши, цвет стен, высоту,ширину, self показывает, что это свойство относится именно к house, 
        self.number = number
